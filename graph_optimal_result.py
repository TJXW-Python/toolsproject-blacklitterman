...
def graph_efficient_frontier(optimal, label = None, color = 'black'):
    text(optimal.opt_var ** .5, optimal.opt_mean, '   tangent', verticalalignment = 'center', color = color)
    scatter(optimal.opt_var ** .5, optimal.opt_mean, marker = 'o', color = color), grid(True)
...
graph_names(names, pi_new + rf, Vp, color = 'red')
